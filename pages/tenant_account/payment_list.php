            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <?php
                  ...
                  $sql_total_transactions = "SELECT COUNT(*) AS total_transactions FROM tblpayment  WHERE tenant_name = '" . $_SESSION['complete_name'] . "'";
                ...
                <div class="table-responsive">
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                        require_once('../includes/dbcon.php');
                        $sql = "SELECT * FROM tblpayment  WHERE tenant_name = '" . $_SESSION['complete_name'] . "' ORDER BY  payment_id DESC";
