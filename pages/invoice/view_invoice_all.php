...
function getInvoiceDetails($conn, $assignment_id) {
    $sql = "SELECT i.*, t.complete_name, t.address, t.email_address, t.contact
            ...
            WHERE i.assignment_id = ? AND i.status = 'paid' AND i.remarks = 'payAll'";
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  To
                  <address>
                    <strong><?php echo $invoices[0]['complete_name'] ?? ''; ?></strong><br>
                    <?php echo $invoices[0]['address'] ?? ''; ?><br>
                    Phone: <?php echo $invoices[0]['contact'] ?? ''; ?><br>
                    Email: <?php echo $invoices[0]['email_address'] ?? ''; ?>
                  </address>
                </div>
                <!-- /.col -->
                <div class="col-sm-4 invoice-col"> 
                  <b>Invoice #<?php echo $invoices[0]['invoice_number'] ?? ''; ?></b><br>
                  <br>
                  <b>Payment Due:</b> <?php echo $invoices[0]['due_date_iterate'] ?? ''; ?><br>
                </div>
                <!-- /.col -->
              </div>
              <!-- /.row -->
