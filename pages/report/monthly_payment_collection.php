      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Payment Collection by Month</h3>
              </div>
              <div class="card-body">
                <canvas id="paymentChart" style="height:230px; min-height:230px"></canvas>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
...
<script>
  $(function () {
    ...
    $query = $conn->query($sql);
    while($row = $query->fetch_assoc()) {
      echo "years.push('".$row['year']."');";
      echo "months.push('".$row['month']."');";
      echo "collections.push('".$row['total_payments']."');";
    }
    ?>
